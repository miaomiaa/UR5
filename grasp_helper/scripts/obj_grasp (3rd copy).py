...
class MoveRobot():
    ...
    def goSP(self):
        ...
        self.arm_group.set_joint_value_target([1.57, 1.55, 1.57, 0, -1.5, -1.57 ])

        ###1.582, -0.0527,1.713,-0.15092505292892455, -0.15092505292892455, -1.57
        ##1.667, 0.453, 2.116, 0, 0, -1.57
        ##1.57, 1.0, 2.09, 0, -1.5, -1.57
        self.arm_group.go()
    def goSP2(self):
    ...
    def goSP4(self):
        ...
        self.arm_group.set_joint_value_target([1.667, 0.453, 2.116, 0, 0, -1.57])
    ...
    def grasp_obj(self):
        ...
        self.Obj_pose.pose.position.z = z2-0.04
        self.arm_group.set_pose_target(self.Obj_pose.pose)
        self.plan_cartesian_path(self.Obj_pose.pose)           
